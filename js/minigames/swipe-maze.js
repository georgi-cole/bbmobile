...
// Swipe Maze - Navigate maze with swipe gestures (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Swipe Gesture Maze';
    ...
    description.textContent = 'Swipe to navigate through the maze and reach the exit quickly!';
