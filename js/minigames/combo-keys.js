...
// Combo Keys - Memorize and repeat key combinations (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Key Combination Memory';
    ...
    description.textContent = 'Watch the combination and repeat it perfectly!';
