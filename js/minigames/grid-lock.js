...
// Grid Lock - Unlock grid patterns puzzle (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Pattern Grid Puzzle';
    ...
    description.textContent = 'Unlock the grid by solving the pattern puzzle!';
