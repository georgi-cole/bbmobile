...
// Chain Reaction - Create chain combos puzzle (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Combo Chain Puzzle';
    ...
    description.textContent = 'Create the longest chain reactions to maximize your score!';
