...
// Memory Zipline - Remember path sequence while ziplining (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Zipline Path Memory';
    ...
    description.textContent = 'Remember the zipline path sequence and recreate it from memory!';
