...
// Social Strings - Connect relationships puzzle (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Relationship Connection Puzzle';
    ...
    description.textContent = 'Connect houseguests based on their relationships and alliances!';
