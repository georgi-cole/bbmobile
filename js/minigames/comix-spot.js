...
// Comix Spot - Spot differences in comic panels (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    title.textContent = 'Comix Spot';
    title.style.cssText = 'margin:0;font-size:1.3rem;color:#e3ecf5;';
    
    const subtitle = document.createElement('div');
    subtitle.textContent = 'Comic Panel Differences';
    ...
    description.textContent = 'Find all the differences between two Big Brother themed comic panels!';
