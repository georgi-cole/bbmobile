...
// Bubble Burst - Pop bubbles quickly for points (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Pop Bubbles Fast';
    ...
    description.textContent = 'Pop as many bubbles as you can before time runs out!';
