...
// Echo Chamber - Audio memory and recall (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Audio Memory Test';
    ...
    description.textContent = 'Listen to sound patterns and repeat them back!';
