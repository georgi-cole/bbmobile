...
// Gear Shift - Solve mechanical gear puzzles (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Mechanical Puzzle';
    ...
    description.textContent = 'Align the gears correctly to solve the puzzle!';
