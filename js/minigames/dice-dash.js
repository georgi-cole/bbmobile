  ...
  function render(container, onComplete, options = {}){
    ...
    function rollDice(){
      ...
      if(sum === target){
        ...
        if(round > 10){
          setTimeout(() => {
            // Calculate raw score: Fewer rolls = better score
            const rawScore = Math.min(100, Math.max(20, 100 - (totalRolls - 10) * 2));
            ...
            if(g.GameUtils && !debugMode && competitionMode){
              ...
              if(!shouldWin && playerSucceeded){
                ...
                console.log('[DiceDash] Win probability applied: success forced to loss');
              }
            }
