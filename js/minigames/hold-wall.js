...
// Hold Wall - Endurance wall hold challenge (Scaffold)
...
(function(g){
  ...
  function render(container, onComplete){
    ...
    subtitle.textContent = 'Endurance Wall Hold';
    ...
    description.textContent = 'Hold your finger on the wall as long as possible without moving!';
