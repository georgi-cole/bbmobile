...
(function(global){
  ...
  function renderNomsPanel(){
    ...
    if(!hoh || !hoh.human){
      ...
      // Human HOH fallback: show simple message
      // The nominations-fullscreen-ceremony.js module will intercept renderNomsPanel
      // If that module is not loaded or fails, this fallback provides a basic UI
      console.log('[noms] Human HOH - awaiting fullscreen ceremony or showing fallback');
      ...
      if(wasHumanPickMode){
        ...
        await new Promise((resolve) => {
          ...
          if(host){
            ...
            // Fallback
            console.warn('[noms-pick] No tvOverlay for adjournment, using fallback');
